...
- 命中（旧口径：actual_ret>0）：9/30（30.00%）
- 覆盖率（V2：in_p10，r_actual ∈ [p05,p95]）：20.00%
- 覆盖率（V2：in_p50，r_actual ∈ [p25,p75]）：6.67%
- MAE（V2：|err_r_p50|）：0.153075
- MAE（V2：|err_close_p50|）：2.168024
